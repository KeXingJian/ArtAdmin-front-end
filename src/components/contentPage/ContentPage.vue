    ...
    <nav class="shell" :class="{ close: isShellClose }">
      <header>
        <div class="image-text">
          <span class="image">
            <img src="/img/微信图片_20241030150838.jpg" alt="">
          </span>
          <div class="text logo-text">
            <a href="#" @click.prevent class="to-font">
              <span class="name">kxj</span>
      ...
      <div class="menu-bar">
        <div class="menu">
          <ul class="menu-links">
            <li class="nav-link" v-for="(link, index) in menuLinks" :key="index">
...
export default {
  data() {
    return {
      ...
      darkMode: false,
      menuLinks: [
        { icon: 'icon-home', text: 'Home',to:'ArtHome' },
        { icon: 'icon-user_01', text: 'Illustrated',to:'ArtIllustrated' },
        { icon: 'icon-zizhi', text: 'Dictionary',to:'ArtDictionary' },
        { icon: 'icon-tupian', text: 'Picture',to:'ArtPicture' },
        { icon: 'icon-jiankong', text: 'Audit',to:'ArtAudit' },
        { icon: 'icon-dunpaibaoxianrenzheng', text: 'Authentication',to:'ArtAuthentication' },
        { icon: 'icon-user_01', text: 'Me',to: 'ArtMe' }
      ]
    };
  },
